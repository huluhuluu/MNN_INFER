...
" #define APPLY_CAUSAL_MASK(score, key_index) "" if ((key_index) > query_start + x4) { score.s0 = -FLT_MAX; } "" if ((key_index) > query_start + x4 + 1) { score.s1 = -FLT_MAX; } "" if ((key_index) > query_start + x4 + 2) { score.s2 = -FLT_MAX; } "" if ((key_index)>query_start+x4+3) { score.s3=-FLT_MAX; }\n"
