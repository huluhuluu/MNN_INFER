...
def build_args(parser):
    ...
    parser.add_argument('--quant_block', type=int, default=0, help='mnn quant block, 0 means channel-wise, default is 0.')
    ...
    parser.add_argument('--lm_quant_bit', type=int, default=16, help='mnn lm_head quant bit, default is 16.')
    ...
    parser.add_argument('--smooth', dest='smooth', action='store_true', default=True, help='Whether or not to use smooth quant, default is True.')
    parser.add_argument('--no-smooth', dest='smooth', action='store_false', help='Disable smooth quant.')
    parser.add_argument('--sym', dest='sym', action='store_true', default=True, help='Whether or not to use symmetric quant (without zeropoint), default is True.')
    parser.add_argument('--no-sym', dest='sym', action='store_false', help='Disable symmetric quant.')
    ...
    parser.add_argument('--seperate_embed', dest='seperate_embed', action='store_true', default=True, help='For lm and embed shared model, whether or not to sepearte embed to avoid quant, default is True.')
    parser.add_argument('--no-seperate_embed', dest='seperate_embed', action='store_false', help='Keep shared embeddings quantized.')
    ...
    parser.add_argument('--act_sym', dest='act_sym', action='store_true', default=True, help='Use symmetric smooth-quant activations, default is True.')
    parser.add_argument('--no-act_sym', dest='act_sym', action='store_false', help='Use asymmetric smooth-quant activations.')
